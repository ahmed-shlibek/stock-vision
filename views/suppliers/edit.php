        ...
        <form action="<?= BASE_URL ?>/suppliers/<?= $supplier['id'] ?>/update" method="POST">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" 
                               ...
                               value="<?= htmlspecialchars(old('email', $supplier['email'])) ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="phone" name="phone" 
                               ...
                               value="<?= htmlspecialchars(old('phone', $supplier['phone'])) ?>">
            ...
            <div class="form-group">
                ...
                <textarea id="address" name="address" 
                          ...
                          rows="3"><?= htmlspecialchars(old('address', $supplier['address'])) ?></textarea>
